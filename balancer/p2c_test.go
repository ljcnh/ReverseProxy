...
func TestP2C_Add(t *testing.T) {
	...
	h1 := &hostLoad{"http://127.0.0.1:1011", 0}
	h2 := &hostLoad{"http://127.0.0.1:1012", 0}
	h3 := &hostLoad{"http://127.0.0.1:1013", 0}
	cases := []struct {
		name   string
		lb     Balancer
		args   string
		...
		{
			"test-1",
			&P2C{hosts: []*hostLoad{h1, h2}, r: rnd,
				hostMap: map[string]*hostLoad{"http://127.0.0.1:1011": h1,
		...
		},
		{
			...
			&P2C{hosts: []*hostLoad{h1, h2}, r: rnd,
				hostMap: map[string]*hostLoad{"http://127.0.0.1:1011": h1,
					"http://127.0.0.1:1012": h2}},
			"http://127.0.0.1:1013",
			&P2C{hosts: []*hostLoad{h1, h2, h3}, r: rnd,
				hostMap: map[string]*hostLoad{"http://127.0.0.1:1011": h1,
